          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className='bg-white p-5 rounded-md shadow-md'>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <div className='mt-1'>
                    <h2 className='tex-lg mb-2'>Kindly upload a photo of the item or design you need welded so I can give you an accurate quote <span className='font-bold'>(optional)</span></h2>
                    <div className='flex justify-center items-center my-4'>
                        <div className='flex flex-col items-center border-gray p-5 rounded-md border-[1.2px] w-fit self-center'
